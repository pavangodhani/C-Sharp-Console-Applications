...
namespace GradeBook.GradeBooks
{
    public abstract class BaseGradeBook
    {
        ...
        {
            System.Console.WriteLine("Student Name : Student Id : Student Type : Student Enrollment\n");

            foreach (var student in Students)
            {
                Console.WriteLine($"{student.Name} : {student.Id} : {student.Type} : {student.Enrollment}");
            }
        }
